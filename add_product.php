            ...
            <div class="card-body p-5">
              ...
              <form action="" method="post">
                ...
                <div class="d-flex justify-content-center">
                  <button id="add-to-cart-btn" onclick="addToCart(1)" type="submit" name="submit" value="submit" class="btn btn-dark" style="margin-top: -25px;">Add Product</button>
                </div>

                <p style="margin-top: 3%;"><a href="customer.php">Back to Dashboard</a></p>
